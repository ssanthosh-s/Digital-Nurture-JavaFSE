...
insert into country (co_code, co_name) values ('BO', ' Plurinational State of Bolivia');
insert into country (co_code, co_name) values ('BQ', 'Sint Eustatius and Saba Bonaire');
